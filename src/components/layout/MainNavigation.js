...
function MainNavigation() {
  ...
  return (
    <header
      className={`${classes.header} ${classes.sticky} ${
        isMenuVisible ? classes.navOpen : ""
      }`}
    >
      <LogoHeader />
      <nav
        className={`${classes.mainNav} ${
          isMenuVisible ? classes.mobileNav : ""
        }`}
      >
